<template>
    <section id="about" class="px-8 py-4 space-y-8 md:px-16 xl:w-2/3 xl:mx-auto">
        <h2 class="text-3xl font-bold sm:text-4xl lg:text-5xl">Qui suis-je ?</h2>
		<div class="gap-8 max-sm:space-y-8 sm:flex sm:items-center sm:text-left lg:w-3/4 lg:mx-auto">
			<div class="w-full space-y-4 sm:w-48">
